...
class DealersListing extends StatefulWidget {
  const DealersListing({Key? key}) : super(key: key);

  @override
  _DealersListingState createState() => _DealersListingState();
}

class _DealersListingState extends State<DealersListing> {
  int statusIndex = 0;
