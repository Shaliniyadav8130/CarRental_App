...
class FeaturedDealersListing extends StatefulWidget {
  const FeaturedDealersListing({Key? key}) : super(key: key);

  @override
  _FeaturedDealersListingState createState() => _FeaturedDealersListingState();
}

class _FeaturedDealersListingState extends State<FeaturedDealersListing> {
  int statusIndex = 0;
