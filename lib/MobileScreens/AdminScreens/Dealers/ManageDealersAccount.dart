...
class ManageDealersAccount extends StatefulWidget {
  const ManageDealersAccount({Key? key}) : super(key: key);

  @override
  _ManageDealersAccountState createState() => _ManageDealersAccountState();
}

class _ManageDealersAccountState extends State<ManageDealersAccount> {
  ...
  Widget build(BuildContext context) {
    return CustomContainer(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Manage Dealers accounts"),
        ),
        body:
        Padding(
