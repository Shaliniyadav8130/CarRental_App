...
class RejectedRequestWidget extends StatelessWidget {
  ...
  const RejectedRequestWidget({Key? key}) : super(key: key);
                    ...
                    Padding(padding: EdgeInsets.only(top:6),
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("here123@gmail.com",style: TextStyle(fontSize: 15,color: Color(0x66000000)),),
                          //SizedBox(height: 5,),
                  ...
                  children: [
                    Expanded(
                      child:ElevatedButton(
                        ...
                        child: Text('Edit Verification',style: TextStyle(color: Colors.white),),
                      ),
