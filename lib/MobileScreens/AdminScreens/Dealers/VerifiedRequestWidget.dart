...
class VerifiedRequestWidget extends StatelessWidget {

  // PendingRequestWidget({
  // });

  const VerifiedRequestWidget({Key? key}) : super(key: key);
                  ...
                  children: [
                    Expanded(
                      child:ElevatedButton(
                        onPressed: () {
                          Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: DealersListing()));
