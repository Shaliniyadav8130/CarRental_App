...
class CompanyAdditionalInfo extends StatefulWidget {
  const CompanyAdditionalInfo({
    Key? key,
  }) : super(key: key);

  @override
  State<CompanyAdditionalInfo> createState() => _CompanyAdditionalInfoState();
}

class _CompanyAdditionalInfoState extends State<CompanyAdditionalInfo> {
