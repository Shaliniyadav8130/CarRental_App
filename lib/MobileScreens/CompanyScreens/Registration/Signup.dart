...
import 'package:carrental/MobileScreens/CompanyScreens/LoginScreen/CompanyLogin.dart';
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: CompanyLoginPage()));
                  },
                  style: ButtonStyle(
