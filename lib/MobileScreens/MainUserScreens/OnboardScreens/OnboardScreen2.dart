          ...
          Row(
            ...
            children: [
              ...
              CircularButton(
                ...
                onPressed: () {
                  Navigator.push(context, PageTransition(type: PageTransitionType.leftToRight, child: OnboardScreen()));},
              ),
              ...
              CircularButton(
                ...
                color1:Color(0xffEF3D49),
                onPressed: () {
                  Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: OnboardScreen3()));
                },
              ),
